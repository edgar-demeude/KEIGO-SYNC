...
This validation utilized a representative subsample of the dataset ($n=72$~responses, derived from 18 of the 60 primary questions across four distinct models), accounting for 10\% of the total response corpus. 
