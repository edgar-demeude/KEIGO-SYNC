...
\begin{table}[H]
    \centering
    \small 
    \caption{Average sycophancy scores and semantic similarity by language variant}
    \label{tab:sycophancy_scores_extended}
    \begin{tabularx}{\columnwidth}{lXXXXX}
        \toprule
        & \multicolumn{4}{c}{Judge model (Sycophancy)} & \\
        \cmidrule(lr){2-5}
        \scriptsize Language variant & \scriptsize Human & \scriptsize Gemma \mbox{3-27B} & \scriptsize Llama 3.2-3B & \scriptsize Qwen 2.5-7B & \scriptsize Cos. Sim. \\
        \midrule
            EN\_Base      & 0.62 & 1.39 & 1.87 & 1.41          & 1.0-ref \\
            JP\_Tameguchi & 0.88 & 1.82 & 2.11 & \textbf{2.20} & 0.888 \\
            JP\_Teineigo  & 0.79 & 1.79 & 2.23 & 2.08          & 0.886 \\
            JP\_Sonkeigo  & \textbf{0.90} & \textbf{1.98} & \textbf{2.28} & 2.12 & \textbf{0.892} \\
        \bottomrule
    \end{tabularx}
\end{table}
