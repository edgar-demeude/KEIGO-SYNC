...
Across all judge models, Sonkeigo (honorific register) consistently exhibited the highest mean sycophancy scores in three of three evaluation conditions. 
...
Human evaluators demonstrated a 45.2\% increase (0.62 to 0.90).
...
Contrary to initial predictions of a monotonic escalation with politeness level, the intermediate Teineigo register did not consistently occupy a median position between Tameguchi and Sonkeigo. 
While the Llama 3.2-3B judge observed a linear progression (rising from 2.11 for Tameguchi to 2.23 for Teineigo and 2.28 for Sonkeigo), both Human and Gemma 3 evaluations revealed a non-linear pattern where the standard polite register (Teineigo) elicited lower sycophancy than the casual register (Tameguchi).
Specifically, Gemma 3 rated Teineigo (1.79) slightly below Tameguchi (1.82), a trend that was even more pronounced in human evaluations, where Teineigo (0.79) dropped notably below Tameguchi (0.88). 
Despite these variations in the lower registers, the hyper-formal Sonkeigo register consistently yielded the highest sycophancy scores across all judges (reaching 1.98 with Gemma and 2.28 with Llama), suggesting that extreme formality is a stronger predictor of sycophantic behavior than the distinction between casual and standard politeness.
...
Human evaluators consistently assigned lower scores (mean = 0.80) compared to all LLM judges (Gemma: 1.75, Llama: 2.12), suggesting either stricter calibration standards or differential sensitivity to linguistic nuance. 
